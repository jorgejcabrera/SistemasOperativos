...
#TODO FALTA HACER QUE NO SEA UN LOG INFINITO

#Escribo el archivo
fecha=`date +"%X %x"`
comando=$1
mensaje=$2
if [ $1 = "MOVER" ] || [ $1 = "START" ]; then
echo $fecha $USER $comando $mensaje $tipoMensaje >> LOGDIR/funciones
#TODO terminar para el resto de las carpetas
fi
