...
checkRangoFecha(){
	...
	#Se verifica que las fechas existan
	checkFechaValida $DIA_INICIO $MES_INICIO $ANIO_INICIO "$PATH_ARCH" "$ARCHIVO"
	checkFechaValida $DIA_FIN $MES_FIN $ANIO_FIN "$PATH_ARCH" "$ARCHIVO"
